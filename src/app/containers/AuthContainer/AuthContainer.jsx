  ...
  return (
    <div className="authcontainer">
      <div className="leftside">
        <img src="https://i.imgur.com/krvHH3a.png" alt="" />
      </div>
        ...
        <form className="authform flex" onSubmit={(e) =>{mainBtn.onClick(states, setStates) ;e.preventDefault()}}>
          ...
          <div className="formbtns flexrow">
            <div className="textbtns flex">
              {btnText1 && <Link to={btnText1.link &&  btnText1.link} onClick={()=> btnText1.onClick && btnText1.onClick()} className="textbtn">{btnText1.text}</Link>}
